...
{ClassAttendance.map((item,index)=> {
    return(
        <div>
                {index===0 ? <div className="ml-4 flex indent-14 justify-center align-middle bg-white w-100 pl-8"><div>1</div><div>2</div><div>3</div><div>4</div></div>:""}
   <div className="flex gap-x-5 ml-4 m-2 bg-white w-100 align-middle justify-around">
